...
public class UserController {
    ...
    @DocsCreateUser
    @PostMapping
    public ResponseEntity<Object> createUser(@RequestBody @Validated(ValidationGroups.OnCreate.class) UserRequestDTO user) {
    ...
    public ResponseEntity<Object> getAllUsers(
            @Parameter(hidden = false, required = false) UserFilter filter, // Parameter se puede quedar aquí o mover al DTO
    ...
    @DocsGetUserById
    @GetMapping("/{id}")
    public ResponseEntity<Object> getUserById(@PathVariable @Parameter(description = "ID del usuario", example = "1000000") Long id) {
    ...
    @DocsUpdateUser
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateUser(@RequestBody @Validated(ValidationGroups.OnUpdate.class) UserRequestDTO user, @PathVariable Long id) {
